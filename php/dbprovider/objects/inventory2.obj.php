...
class Inventory2 extends dbodbcBase {
    ...
    public function getWhereSql($params = "") {
        if (isset($params['ordnbr'])) {
            $sql = $this->buildOrderSql($params);
            return $sql;
        }
        if (isset($params['ponbr'])) {
            $sql = $this->buildPurchaseOrderSql($params);
            return $sql;
        }
        if (isset($params['openpos'])) {
            $sql = $this->buildOpenPOSql();
            return $sql;
        }
        if (isset($params['opensos'])) {
            $sql = $this->buildOpenSOSql();
            return $sql;
        }
        if (isset($params['vmiitems'])) {
            $sql = $this->buildVMIItems();
            return $sql;
        }
