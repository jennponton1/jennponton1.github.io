<?php /* Smarty version 2.6.13, created on 2012-02-24 09:34:34
         compiled from C:%5Cinetpub%5Cwwwroot%5Caccountspayable%5Cdataentry%5CWoodVouchers%5Cjennifer/views/UnvReceipts.html */ ?>
                    ...
                    <div style="width:60%; background-color: #eeeeee;float:right">
                        <table style="width:30%;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width:9%;"><b>&nbsp;Total Qty:</b></td>
                                    <td style="width:9%;"><input type="text" name="totqty" id="totqty" readonly="readonly" value=<?php echo $this->_tpl_vars['totqty']; ?>
></td>
                                </tr>
                                <tr>
