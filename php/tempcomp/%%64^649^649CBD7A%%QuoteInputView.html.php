<?php /* Smarty version 2.6.13, created on 2014-10-07 11:44:02
         compiled from C:%5Cinetpub%5Cwwwroot%5Cordersandshipments%5Cdataentry%5Cquotes/views/QuoteInputView.html */ ?>
<!DOCTYPE html>
<html>
    <head>
 ...
 -->
        ...
        <script type="text/javascript" src="js/utils.js?v=<?php echo time(); ?>
"></script>
...
"></script>
        <script type="text/javascript" src="js/quoteEmail.js?v=<?php echo time(); ?>
"></script>
        <script type="text/javascript" src="js/QuoteInput.js?v=<?php echo time(); ?>
"></script>
        <script type="text/javascript" src="js/emailAddresses.js?v=<?php echo time(); ?>
"></script>
        <script type='text/javascript' src='js/detailEdit.js?v=<?php echo time(); ?>
'></script>
        <script type='text/javascript' src='js/quoteConfirm.js?v=<?php echo time(); ?>
'></script>
        <script type='text/javascript' src='js/buildOrder.js?v=<?php echo time(); ?>
'></script>
        <!--<link type='text/css' href="/globals/css/bootstrap/bootstrap-responsive.min.css" rel="stylesheet">
        <script type='text/javascript' src='/globals/js/bootstrap/bootstrap.min.js?v=<?php echo time(); ?>
'></script>-->
...
>
            <div id="mainBodyContent" >
                <div id="Header" >
                    ...
                    <table id="hdrTable" >
                        <tbody>
                            <tr><td style="width:5%;"><b>&nbsp;Quote Number:</b></td>
                                <td style="width:4%;">
                                    <input id="QuoteNbr" type="text" style="width:100%; background-color:#dddddd;" name="QuoteNbr" tabindex="40" readonly="readonly" value=<?php echo $this->_tpl_vars['QuoteNbr']; ?>
></td>
                                <td style="width:4%;">
                                    <input id='RevNbr' type='hidden' name='RevNbr' tabindex='-1' value=''>
                                    <div id="divRevNbr"></div>
                                </td>
                                <td style="width:8%;"><button class="entrybutton" id="UpdateCost" type="button" tabindex="41" >Update Pricing</button>
                                ...
                                <td style="width:8%;"><div id="templateLink"></div></td>                                

                                <td style="width:12%;"><b>Retrieve Quotes:</b>
                            ...
                            <div id="edittab-1">
                                <table id='frtboxTbl' >
                                    <tbody>
                                        ...
                                        <tr >
                                            <td>
                                                <span  class='trkFrtRow railFrtRow'>
                                                    <b>Rate:</b>
                                                </span>
                                            </td>
                    ...
                    <div>
                        <div style="width:50%; height:24.5%; background-color:#eeeeee; float:left">
                            ...
                            <table style="width:100%;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td id="showTemplate" style="text-align: center; width: 20%; "></td>
                            ...
                            <table style="width:100%;">
                                <tbody>
                                    <tr>
                                        <td style="width:4%;"><button id="FileSave" class="entrybutton" type="button" tabindex="34" >Save</button></td>
                                        <td style="width:4%;"><button id='FileSaveAs' class='entrybutton' type='button' tabindex='35'>Create / Update Template</button></td>                                        
                                        <td style="width:4%;"><button id="FileNew" class="entrybutton" type="button" tabindex="36">Reset</button></td>
                                        <td style="width:4%;"><button id="FileEmail" class="entrybutton" type="button" tabindex="37" >Email</button></td>
                                        <td style="width:14%;"><button id="FileOrder" class="entrybutton" type="button" tabindex="38">Make Order</button></td>
                                        <td style="text-align: right; width:22%;"><b>Close Quote:</b></td>
                                        <td style="width:22%;"><input type=checkbox name=Closeq id=Closeq tabindex="37" ></td>
                                    </tr>
                                </tbody>
                            </table>
                            <?php endif; ?>
