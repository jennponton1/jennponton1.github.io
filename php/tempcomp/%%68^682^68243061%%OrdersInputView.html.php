<?php /* Smarty version 2.6.13, created on 2015-01-21 17:15:56
         compiled from C:%5Cinetpub%5Cwwwroot%5Cordersandshipments%5Cdataentry%5Corderentry%5COrders/views/OrdersInputView.html */ ?>
<!DOCTYPE HTML>
<html>
    <head>
 ...
 -->
    ...
    <script type="text/javascript" src="js/shippingAddress.js?v=<?php echo time(); ?>
"></script>
    <script type="text/javascript" src="js/emailaddresses.js"></script>
    <script type="text/javascript" src="js/buildDelivery.js"></script>
    <script type="text/javascript" src="js/buildSuggest.js"></script>
    <script type="text/javascript" src="js/gridmanager.js?v=<?php echo time(); ?>
"></script>
    <script type="text/javascript" src="js/ordersedit.js"></script>
    <script type="text/javascript" src="js/ordernotes.js"></script>
    <script type="text/javascript" src="js/OrdersInput.js?v=<?php echo time(); ?>
"></script>
    </head>
    <body>
...
>
    ...
    <input type="hidden" name="UserGroups" id="UserGroups" value="<?php echo $this->_tpl_vars['UserGroups']; ?>
">
    ...
    <div style="background-color:#eeeeee; width:100%; height:97%">
       <div id="Header" style="margin-left:.25%; height:6%; width:99.25%">
          ...
          <table style="width:100%;">
             <tbody>
                   <tr><td style="width:5%; text-align: right;"><b>Customer:</b></td>
                       ...
                       <td style="width:6%; text-align:right;"><b>Order Number:</b></td>
                       <td style="width:8%;">
                                  <select id="Order" name="Order" style="width:100%; height:22px; font-size:14px;" tabindex="1">
                                  </select></td>
                       <td style="width:6%; text-align:right;"><b>Edited by:</b></td>
...
></td>
                       <td style="width:7%; text-align:right;"><b>Sales Person:</b></td>
                       ...
                       <td style="width:7%; text-align:right;"><b>Order Date:</b></td>
       ...
       <div style="background-color:#eeeeee; width:100%;" id="textform">
          <div style="width:100%; min-height:20%; max-height:25%" id="Info">
                ...
                <table style="width:100%;">
                   <tbody>
                         <tr><td style="width:18%;"><b class="entrylabel" >&nbsp;CustOrdNbr:</b></td>
                             ...
                             <td style="width:18%; text-align:right;"><b class="entrylabel" >ShipDate:</b></td>
                ...
                <table style="width:100%;">
                   <tbody>
                         <tr><td style="width:10%;"><b class="entrylabel">ShipVia:</b></td>
                             <td style="width:40%; height:22px; font-size:12; text-align:right;">
                             ...
                             <td style="width:12%; text-align:right;"><b class="entrylabel">&nbsp;Collect:</b></td>
                         ...
                         <tr><td style="width:10%;"><b class="entrylabel">FOB:</b></td>
                             <td style="width:40%;"><input type="text" id="Fob" name="Fob" class="readonly" style="width:100%; font-size:12" tabindex="558" readonly="readonly"></td>
                             <td colspan='3'></td>
                         </tr>
                         <tr><td style="width:10%;"><b class="entrylabel">Plant:</b></td>
                             <td style="width:40%;"><input type="text" id="PlantDisp" name="PlantDisp" class="readonly" style="width:100%; font-size:12" tabindex="559" readonly="readonly"></td>
                             <td colspan='3'></td>
                         </tr>
                   </tbody>
                </table>
             ...
             <div style="margin-left:.25%; width:22.5%; border:solid black; border-width:1; background-color:#eeeeee; float:left">
                <table style="width:100%;">
                   <tbody>
                         <tr><td style="width:60%; height:26px; vertical-align: middle;" class="floattitle">
                                 <span style="width: 80%; display: inline-block;">
                                     &nbsp;Shipping Address
                                 </span> 
                                <button class="entrybutton rightaligned" id="ShipChg" type="button" tabindex="9">Change</button>
                             </td></tr>
                   </tbody>
                </table>
                <table style="width:100%;">
                ...
                <table style="width:100%;">
                   <tbody>
                         <tr><td style="width:3%;"><button class="entrybutton" id="ALine" type="button" tabindex="10">Add Line</button></td>
                             ...
                             <td style="width:18%; height:22px; text-align:right;">
                             ...
                             <td style="width:6%; text-align:right;"><button class="entrybutton" id="DelvdPrcBtn" type="button" tabindex="15">Delivered Prices</button></td>
                             <td style="width:6%; text-align:leftt;"><button class="entrybutton" id="FreqBtn" type="button" tabindex="16">Most Frequent</button></td>
                             <td style="width:15%;">&nbsp;</td>
                             <td style="width:5%; font-size:12px; text-align:right;"><b class="entrylabel">Total BF:</b></td>
                             ...
                             <td style="width:2%;">&nbsp;</td>
                             <td style="width:6%; text-align:right;"><b class="entrylabel">Order Total:</b></td>
